...
namespace RMC.MyProject.Scenes
{
    ...
    public class Scene01_Intro : MonoBehaviour
    {
        ...
        [Header("VFX")]
        [SerializeField]
        private VisualEffect _smokeVisualEffect;

        [SerializeField]
        private VisualEffect _sparksVisualEffect;
        ...
        private async void PlayVisualEffectsAsync(int durationMS)
        {
            _smokeVisualEffect.Play();
            _sparksVisualEffect.Play();
